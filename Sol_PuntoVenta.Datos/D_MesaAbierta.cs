...
namespace Sol_PuntoVenta.Datos
{
    public class D_MesaAbierta
    {
        ...
        public DataTable Guardar_RP(E_RegristroPedido oRP, DataTable Detalle_ticket)
        {
            SqlDataReader Resultado;
            DataTable Tabla = new DataTable();
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                Comando.Parameters.Add("@nCodigo_us", SqlDbType.Int).Value = oRP.Codigo_us; // revisar
        ...
        public DataTable Mostra_Ticket(int nCodigo_ti)
        {
            SqlDataReader Resultado;
            DataTable Tabla = new DataTable();
            SqlConnection SqlCon = new SqlConnection();
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("USP_Mostra_ticket", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@nCodigo_ti", SqlDbType.Int).Value = nCodigo_ti;
                SqlCon.Open();
                Resultado = Comando.ExecuteReader();
