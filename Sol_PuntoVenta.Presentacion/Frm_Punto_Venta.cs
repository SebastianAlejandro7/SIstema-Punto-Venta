...
namespace Sol_PuntoVenta.Presentacion
{
    public partial class Frm_Punto_Venta : Form
    {
        ...
        private void Listado_pv(string cTexto)
        {
            try
            {
                Dgv_Listado.DataSource = N_Punto_Venta.Listado_pv(cTexto); // Mediacion del contenido
                this.Formato_pv();
        ...
        {
            if (string.IsNullOrEmpty(Convert.ToString(Dgv_Listado.CurrentRow.Cells["codigo_pv"].Value))) // Convierte a string para evaluarlo
            {
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string Rpta = "";
                    E_Punto_Ventas oPrpiedad = new E_Punto_Ventas();
                    oPrpiedad.Codigo_pv = this.nCodigo;
                    oPrpiedad.Descripcion_pv = Txt_descripcion.Text.Trim();
                    Rpta = N_Punto_Venta.Guardar_pv(this.Estadoguarda, oPrpiedad);
                    if (Rpta.Equals("OK"))
                    {
